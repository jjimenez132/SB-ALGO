...
from data_pipeline.sources import mysportsfeeds as source

APIError = source.MySportsFeedsError
SEASON = "2023-2024-regular"
PLAYER_NAME = "Jayson-Tatum"
TEAM_ABBR = "BOS"
GAME_ID = "20240115-BOS-TOR"
...
def run_tests(base_date: dt.date) -> None:
    ...
    print_section("Player Game Logs", player_stats, errors)
    ...
    print_section("Team Game Logs", team_stats, errors)

    boxscore, errors = attempt_fetch(
        source.fetch_boxscore,
        SEASON,
        GAME_ID,
    )
...
def main() -> None:
    parser = argparse.ArgumentParser(description="MySportsFeeds source test harness")
    parser.add_argument(
        "--today",
