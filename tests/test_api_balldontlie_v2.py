...
from data_pipeline.sources import balldontlie_v2 as source

APIError = source.BalldontlieAPIError
PLAYER_ID = 237  # LeBron James
TEAM_ID = 14  # Lakers
GAME_ID = 900001
...
def main() -> None:
    parser = argparse.ArgumentParser(description="balldontlie v2 source smoke test")
    parser.add_argument(
        "--today",
